...
COIN_NAME='YERBAS'
COIN_CLI='yerbas-cli'
COIN_URL='https://github.com/The-Yerbas-Endeavor/yerbas/releases/download/v3.1.4.20/'
COIN_URL_ARM='yerbas-arm64-v3.1.4.20.tar.gz'
COIN_URL_UBUNTU='yerbas-ubuntu20-v3.1.4.20.tar.gz'
COIN_URL_POWER='powcache.dat'
COIN_URL_BOOT='bootstrap.zip'
COIN_VERSION_NAME='v3.1.4.20 -- Smokin Sloth - Second Splif'
